        ...
        <div className="mt-6 p-4 border rounded-md bg-gray-50">
          ...
          {executionTime && (
            <div className="mb-2">
              ...
              <span className="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-medium bg-green-100 text-green-800">
                {executionTime}s
              </span>
            </div>
          )}
          {output && (
            <div>
              ...
              <pre className="mt-1 p-2 bg-gray-900 text-white rounded-md text-sm whitespace-pre-wrap break-all">
                {output}
              </pre>
            </div>
          )}
          {error && (
            <div className="mt-2">
              ...
              <pre className="mt-1 p-2 bg-red-50 text-red-800 rounded-md text-sm whitespace-pre-wrap break-all">
                {error}
              </pre>
            </div>
          )}
